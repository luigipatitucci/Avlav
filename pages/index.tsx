    ...
    <Layout>
      ...
      <main className={styles.main}>
        <Hero 
          ...
          subtitle="Soluciones digitales integrales pensadas para tu negocio" 
          ...
          <div className={styles.manifestoContainer}>
            <div className={styles.manifestoGrid}>
              <div className={styles.manifestoLeft}>
                ...
                <h2 className={styles.manifestoTitle}>CONSTRUIMOS MARCAS QUE CONECTAN</h2>
              </div>
        ...
        <section className={styles.resultsSection}>
          <div className={styles.resultsContainer}>
            <div className={styles.resultsContent}>
              <h2 className={styles.resultsTitle}>RESULTADOS QUE IMPULSAN TU NEGOCIO</h2>
        ...
        <section className={styles.ctaSection}>
          <div className={styles.ctaContainer}>
            <div className={styles.ctaContent}>
              <h2 className={styles.ctaTitle}>¿LISTO PARA POTENCIAR TU MARCA?</h2>
